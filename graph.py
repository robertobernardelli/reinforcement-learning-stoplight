...
e12 = ListNode(point_converter(7.3059460451904,-5.887408832075)) #O
f12 = Node(point_converter(7.2471840046297,-5.5478948199465)) #Q1
g12 = ListNode(point_converter(7.1786370182653,-4.8757841472108)) #O2
h12 = Node(point_converter(7.0779503764026,-3.9245860696794)) #Q
i12 = ListNode(point_converter(7.0075517331237,-2.6399408667794)) #O1
j12 = Node(point_converter(6.9212211549286,-0.4360088089096)) #U
k12 = FinalNode(point_converter(6.8786675544329,0.336442187715), 1) #D
nodelist_12 = [a12, b12, c12, d12, e12, f12, g12, h12, i12, j12, k12]
...
e13 = ListNode(point_converter(4.0119539497933,-4.4808026920525)) #K
f13 = Node(point_converter(2.2833441826018,-3.7828990624901)) #S
g13 = Node(point_converter(0.6330931851997,-3.084519798628)) #L
h13 = FinalNode(point_converter(-0.4361206568454,-2.6355857151185), 1) #H
nodelist_13 = [f12, a13, b13, c13, d13, e13, f13, g13, h13]
...
c14 = ListNode(point_converter(8.934146482221,-5.7803271575225)) #S1
...
e21 = ListNode(point_converter(6.5335081648615,-4.937954816767)) #N
f21 = Node(point_converter(6.5420046027074,-5.1970326566709)) #V1
g21 = ListNode(point_converter(6.6528615596325,-6.1014224686689)) #L1
...
k21 = FinalNode(point_converter(6.9189751659345,-11.0009702155318), 1) #G
nodelist_21 = [a21, b21, c21, d21, e21, f21, g21, h21, i21, j21, k21]
...
b34 = Node(point_converter(3.6162345714634,-5.1395906086797)) #N1
c34 = Stoplight(point_converter(5.36420836424,-5.6743050384899)) #U1
d34 = Node(point_converter(6.10661293896,-5.770921111209)) #K1
e34 = ListNode(point_converter(6.6920561434004,-5.7721158744567)) #P1
f34 = Node(point_converter(6.9207563500377,-5.771170811574)) #J1
g34 = ListNode(point_converter(7.4619308275128,-5.7617776331923)) #O
...
e43 = ListNode(point_converter(7.3601685154079,-4.8764639548107)) #W1
f43 = Node(point_converter(7.1458469367752,-4.8774079402132)) #O2
g43 = ListNode(point_converter(6.468678699198,-4.8780178654791)) #N
...
forbidden_paths = [(a21, k12), (a12, k21), (a34,h13), (a43, e14)]
starting_points = [a12, a21, a34, a43]
ending_points = [k12, h13, e14, k21]